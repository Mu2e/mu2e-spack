...
class Mu2ePcieUtils(CMakePackage):
    ...
    version("v9_02_00", commit="97051e3e6f023af2c9c38b4ab2708761f812e9cb")
    version("v9_01_00", commit="0fcf8dcb93c8b36f88e5ad51375a7c831e51c867")
    version("v8_05_00", commit="a00aa12aaa14703ae4ecb04d5ca21562ae3b5ee2")
    version("v8_04_00", commit="78fb5bb133e8a3bab3dccb51c7c30c8f0390be23")
    version("v8_03_00", commit="ed7b7b4efc8f170d4814f11cdba4583db35c4015")
    version("v8_02_00", commit="2ad37c664444df71adac7b9c7debc4986c8a84be")
    version("v8_01_00", commit="72a0baf26cf059871807f09a4a092facb2df13bf")
    version("v8_00_00", commit="8b1000c1ba381479561f70c68e53801ad06e2119")
    version("v7_00_00", commit="aa04579c3c1b331a9e597f65e21e817035b853d0")
    version("v6_00_00", commit="ac702f65ca1379197ffebac08747ee0bd2600ea4")
    version("v5_00_00", commit="c542277ef033f1af6bfd8c75d30cd1a73f32b388")
    ...
    version(
        "v2_09_01",
        sha256="de7debf74d81739dbfe3e7d4a7365a4c57ed3150ffd49fb5b5504f410dd469c6",
    )
    version(
        "v2_08_05",
        sha256="2e78e63c9f71b0293b6e09315a17f809b42a40d5bc1e7b2cc4efc8f3b042a79b",
    )
    version(
        "v2_08_00",
        sha256="e322ff8f4fbc2c8aaf59ce1afcc5ac410b459717df18ba5432ea9f96be609083",
    )
    ...
    depends_on("artdaq-core-mu2e@v4_00_00:,develop", when="@v4_00_00:,develop")
    ...
    def cmake_args(self):
        args = [
            ...
            "-DBUILD_ROOT_INTERFACE={0}".format(
                "TRUE" if "+root" in self.spec else "FALSE"
            ),
