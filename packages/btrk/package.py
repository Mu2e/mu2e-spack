...
class Btrk(SConsPackage):
    ...
    version(
        "1.02.47",
        sha256="ec581e62a20049da9939b8a62df866a00a9be3298d223fdda1b27d39f11f9928",
    )
    version(
        "1.02.46",
        sha256="5cc136cef7835a9cc792cd857b6fb6e94e788fd1ace07938d4599562e6740e4d",
    )
    version(
        "1.02.45",
        sha256="59d7c5afdedadb774c8a2c5ba3bbbe003d7cb09510c7a44d280cef4f511059a8",
    )
    version(
        "1.02.43",
        sha256="55eb787f156f380c80240b9f91d99963db47f015988d4cbdd3ee09e95af7759e",
    )
    version(
        "1.02.41",
        sha256="4b233ebe252f82a1f4d857c04b44c6a62a49049ed69172cb347a1b180b50770c",
    )
    ...
    def patch(self):
        filter_file(
            r"for var in \[ 'LD_LIBRARY_PATH',  'GCC_FQ_DIR',  'PATH', 'PYTHONPATH',  'ROOTSYS', 'PYTHON_ROOT', 'PYTHON_DIR' \]:",
    ...
    def install(self, spec, prefix):
        install_tree("%s/lib" % self.stage.source_path, prefix.lib)
        ...
        for d in headerlist.directories:
            mkdirp(
                join_path(prefix.include, os.path.relpath(d, self.stage.source_path))
            )
        for f in headerlist.headers:
            install(
                f, join_path(prefix.include, os.path.relpath(f, self.stage.source_path))
            )
